...
exports.getHospitalFakeAssets = void 0;
var jabber_1 = __importDefault(require("jabber"));
var jabber = new jabber_1.default();
function getRandomBatteryStatus() {
    return Math.floor(Math.random() * 101);
}
var getHospitalFakeAssets = function () {
    var hospitalAssets = [
        {
            id: 1,
            batteryLevel: 15,
            tagId: "1u4v5w6x",
            name: "Tag1 Ingresso",
            description: "Tempora voluptas animi molestiae. Repellendus omnis eos cumque quam. Quaerat voluptates voluptate autem est ipsam. Consequatur corrupti iste architecto ex aliquam autem quia.",
            floor: 4,
...
exports.getHospitalFakeAssets = getHospitalFakeAssets;
