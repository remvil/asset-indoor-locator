...
import {ENVIRONMENT, HOST_SERVER_PORT} from "../envconfig";
 ...
 *
 */
apiRouter.get("/healthcheck", (_req: Request, res: Response) => res.json({message: `Hey I'm still alive and listening on port ${HOST_SERVER_PORT}`}));
if (ENVIRONMENT === "demo") {
	// Dummy data API
